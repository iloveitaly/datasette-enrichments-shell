...
# TODO is this actually required for poetry?
def main():
    pass
...
class ShellEnrichment(Enrichment):
    ...
    async def enrich_batch(
        ...
        for row in rows:
            ...
            input_data = self._prepare_input(row, input_mode, single_column).encode(
                "utf-8"
            )
    ...
    def _prepare_input(self, row, input_mode, single_column):
        if input_mode == "json":
